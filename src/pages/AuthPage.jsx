...
export default function AuthPage() {
  ...
  const handleSignUp = async (e) => {
    ...
    if (error) {
      ...
      // Save profile so admin can look up user by email
      if (data?.user) {
    ...
    <div className="auth-page">
      ...
      <div className="auth-right">
        ...
        <div style={{ marginTop: 32, textAlign: 'center' }}>
          <span style={{ color: 'var(--muted)', fontSize: 13 }}>Trainer? </span>
          <a href="/trainer" style={{ color: 'var(--accent)', fontSize: 13, textDecoration: 'none', fontWeight: 600 }}>Login to Trainer Portal →</a>
        </div>
      </div>
    </div>
  )
